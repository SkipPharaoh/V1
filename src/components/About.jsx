    ...
    return(
        <div className="About" id="about">
            <div className="Intro">
                ...
                <h1>A full Stack Developer building different things for the internet.</h1>
                <p>I would love to be apart of an exceptional team who creates exceptional digital experiences. I have a huge interest in working within the FinTech, Investment, or Technology industry.</p>
            </div>
            <div className="Me">
                <h1> <u>About Me</u> </h1>
