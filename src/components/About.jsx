...
function About(){
    return(
        <div className="About" id="about">
            <div className="Intro">
                <h3 className='text-3xl font-bold'>Hi, my name is</h3>
                <h1 className='text-5xl font-bold'>Caniggia Thompson.</h1>
                <h1 className='text-3xl font-bold'>I solve problems & build things on the internet.</h1>
                <p>A full Stack Developer with a passion and tenacious for problem-solving. I would love to be apart of an exceptional team who creates exceptional digital experiences. I have a huge interest in working within the FinTech, Investment, or Technology industry.</p>
            </div>

            <div className="me-flex">
                <h1 className='text-3xl font-bold underline' id='me-header'> About Me</h1>
                <div className="Me">
