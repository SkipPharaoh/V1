...
function SideFooter(){
    return(
        <div className="Contacts">
            ...
            <a href={require('../assets/docs/Disc.pdf')} target="_blank" className="block mt-4 lg:inline-block lg:mt-0 dark:text-white text-blue-100 transition duration-500">
